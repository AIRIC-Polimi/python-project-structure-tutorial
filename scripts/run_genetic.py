...
Mutation is done by randomly assigning new characters with uniform probability.""")
    ...
    parser.add_argument("-i", "--iterations", type=int, default=1000, help="The number of iterations to run the algorithm for.")
    parser.add_argument("-v", "--verbose", action="store_true", default=False, help="Whether to increase the log level for a more verbose output.")
